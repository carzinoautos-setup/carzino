    ...
    <div className="space-y-2" onClick={(e) => e.stopPropagation()}>
      <div className="flex gap-2">
        <input
          ...
          className="carzino-search-input carzino-input w-1/2 px-2 py-8 border border-gray-300 rounded focus:outline-none"
          style={{ height: '55px' }}
        />
        <input
          type="text"
    ...
    <div className="space-y-3">
      <div className="flex gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="carzino-search-input carzino-input w-full pl-6 pr-8 py-8 border border-gray-300 rounded focus:outline-none"
            style={{ height: '55px' }}
          />
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="carzino-search-input carzino-input w-full pl-6 pr-8 py-4 border border-gray-300 rounded focus:outline-none"
          />
          <span className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500 text-xs">/mo</span>
        </div>
      </div>
      ...
      <div>
        ...
        <select
          ...
          className="carzino-select w-full px-2 py-4 border border-gray-300 rounded focus:outline-none"
        >
        ...
        <div className="mb-6">
          ...
          <div className="relative rounded-md overflow-hidden">
            <input
              ...
              className="carzino-search-input carzino-input w-full px-3 py-8 pr-12 border border-gray-300 rounded-md focus:outline-none focus:border-red-600 bg-white"
              style={{ height: '55px' }}
            />
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            ...
            <select
              ...
              className="carzino-select w-full px-3 py-8 border border-gray-300 rounded text-sm focus:outline-none focus:border-red-600 bg-white"
              style={{ height: '55px' }}
            >
