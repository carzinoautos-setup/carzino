    ...
    <div className="space-y-2" onClick={(e) => e.stopPropagation()}>
      <div className="flex gap-2">
        <input
          ...
          className="carzino-search-input carzino-input w-1/2 px-2 py-3 border border-gray-300 rounded focus:outline-none"
        />
        <input
          type="text"
          placeholder="$100,000"
    ...
    <div className="space-y-3">
      ...
      <div>
        ...
        <select
          ...
          className="carzino-select w-full px-2 py-3 border border-gray-300 rounded focus:outline-none"
        >
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="carzino-search-input carzino-input w-full pr-6 px-2 py-3 border border-gray-300 rounded focus:outline-none"
            />
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="carzino-search-input carzino-input w-full pl-6 px-2 py-3 border border-gray-300 rounded focus:outline-none"
            />
          </div>
        </div>
      </div>
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-3 py-6 pl-10 border border-gray-300 rounded text-sm focus:outline-none focus:border-red-600 bg-white"
            />
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            <input
              ...
              className="w-full px-3 py-6 border border-gray-300 rounded text-sm focus:outline-none focus:border-red-600 bg-white"
            />
            <select
