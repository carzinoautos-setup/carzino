    ...
    <div className="space-y-2" onClick={(e) => e.stopPropagation()}>
      <div className="flex gap-2">
        <input
          ...
          className="carzino-search-input carzino-input w-1/2 px-2 py-1.5 border border-gray-300 rounded focus:outline-none"
        />
        <input
          type="text"
          placeholder="$100,000"
    ...
    <div className="space-y-3">
      ...
      <div>
        ...
        <select
          ...
          className="carzino-select w-full px-2 py-2.5 border border-gray-300 rounded focus:outline-none"
        >
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="carzino-search-input carzino-input w-full pr-6 px-2 py-2.5 border border-gray-300 rounded focus:outline-none"
            />
        ...
        <div className="mb-6">
          ...
          <div className="relative overflow-hidden rounded-md">
            <input
              ...
              className="carzino-search-input carzino-input w-full px-3 py-3 border border-gray-300 rounded-md focus:outline-none focus:border-red-600"
            />
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            <input
              ...
              className="carzino-search-input carzino-input w-full px-3 py-4 border border-gray-300 rounded text-sm focus:outline-none focus:border-red-600 bg-white"
            />
            <select
